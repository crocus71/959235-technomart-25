...
* Студент: [Lada Romazanova](https://up.htmlacademy.ru/htmlcss/25/user/959235).
* Наставник: `Александр Кулаков`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/959235-technomart-25) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
